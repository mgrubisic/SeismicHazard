function [lny, sigma,tau,sig] = AB_2006_ENA(T, M,Rcd, stress, Vs30)
...
if Vs30>=2000 || Vs30==Vref
    ...
    %pgaBC = BA_2006_ENA(M, 0, Rcd, stress, Vref);
    pgaBC  = exp(AB_2006_ENA(0, M,Rcd, stress, Vref));
    if pgaBC<=60
