...
if nargin >= 2
    for idx = 1:2:length(varargin)
        switch lower(varargin{idx})
            ...
            case 'marker'
                markerlist{markeridx} = varargin{idx+1}; %#ok<*AGROW>
...
try
    urlwrite(url,filepath); %#ok<*URLWR>
...
function update_google_map(obj,evd) %#ok<*INUSL>
